-- Script de correction pour la migration des sneakers
-- Gestion des conflits d'ID et des contraintes
...
-- Migration des produits sneakers SANS la contrainte active = true
...
SELECT 
    ...
    COALESCE(pv.created_at, CURRENT_TIMESTAMP), COALESCE(pv.updated_at, CURRENT_TIMESTAMP)
