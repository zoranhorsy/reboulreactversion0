...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function updateFrame() {
      if (!isVisible.current || isPaused.current) return;
    ...
    function generateColor(): ColorRGB {
      // Effet fumée grise plus foncée pour plus de contraste
      const baseIntensity = 0.25 + Math.random() * 0.25; // Entre 0.25 et 0.5 pour un gris plus foncé
      const variation = 0.05 + Math.random() * 0.1; // Petite variation pour plus de réalisme

      return {
        r: baseIntensity - variation * 0.2,
        g: baseIntensity - variation * 0.1,
        b: baseIntensity + variation * 0.1,
      };
    }
