  ...
  return (
    <div className="flex flex-col min-h-screen bg-background dark:bg-black text-foreground dark:text-white">
      ...
      <div className="sticky top-0 z-50 w-full h-14 border-b border-border dark:border-zinc-800 bg-background/80 dark:bg-black/80 backdrop-blur-md flex items-center px-4">
        <Link
          href="/catalogue"
          className="inline-flex items-center text-muted-foreground hover:text-foreground dark:text-zinc-400 dark:hover:text-white transition-colors"
        >
          <span>←</span>
          <span>Retour</span>
        </Link>
      ...
      <div className="flex-1 flex flex-col px-4 py-4 max-w-md mx-auto text-center justify-center items-center">
        ...
        >
          <svg
            viewBox="0 0 100 100"
            className="w-full h-full stroke-foreground dark:stroke-white"
          >
            <circle
              cx="50"
              cy="50"
        ...
        >
          <h1 className="text-3xl font-light mb-4 tracking-wide uppercase">
            Produit introuvable
          </h1>
          <p className="text-muted-foreground dark:text-zinc-400 mb-6">
            L&apos;article que vous recherchez n&apos;est pas disponible ou
            n&apos;existe plus dans notre catalogue.
          </p>

          <div className="p-4 my-6 bg-muted/50 dark:bg-zinc-900/50 rounded-lg border border-border dark:border-zinc-800">
            <p className="text-sm italic text-muted-foreground dark:text-zinc-400">
              {randomTip}
            </p>
          </div>
        </motion.div>
