...
export default function AdminProductsPage() {
    ...
    useEffect(() => {
        const filtered = products.filter(product =>
            ...
            (activeStoreType === 'all' || product.storeType === activeStoreType)
        );
                        ...
                        <TabsContent value="adult">
                            <Card>
                                ...
                                <CardContent>
                                    <div className="overflow-x-auto">
                                        <ProductTable
                                            filteredProducts={filteredProducts.filter(p => p.storeType === 'adult')}
                                            categories={categories}
                                            sortConfig={sortConfig}
                                            handleSort={handleSortWrapper}
                                            handleEditProduct={handleEditProduct2}
                        ...
                        <TabsContent value="kids">
                            <Card>
                                ...
                                <CardContent>
                                    <div className="overflow-x-auto">
                                        <ProductTable
                                            filteredProducts={filteredProducts.filter(p => p.storeType === 'kids')}
                                            categories={categories}
                                            sortConfig={sortConfig}
                                            handleSort={handleSortWrapper}
                                            handleEditProduct={handleEditProduct2}
                        ...
                        <TabsContent value="sneakers">
                            <Card>
                                ...
                                <CardContent>
                                    <div className="overflow-x-auto">
                                        <ProductTable
                                            filteredProducts={filteredProducts.filter(p => p.storeType === 'sneakers')}
                                            categories={categories}
                                            sortConfig={sortConfig}
                                            handleSort={handleSortWrapper}
                                            handleEditProduct={handleEditProduct2}
