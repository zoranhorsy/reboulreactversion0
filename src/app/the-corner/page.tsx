...
export async function generateMetadata({ searchParams }: TheCornerPageProps): Promise<Metadata> {
  ...
  let description = "Découvrez notre sélection de vêtements premium de The Corner chez Reboul Store."
  ...
  return {
    ...
    openGraph: {
      ...
      description,
      type: "website",
      url: "https://reboul-store.com/the-corner",
      images: [
        {
