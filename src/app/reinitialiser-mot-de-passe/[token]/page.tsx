...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      logWithTime("Mot de passe réinitialisé avec succès", {
        email,
    ...
    if (tokenValid === false) {
      return (
        <div className="text-center py-6">
          ...
          >
            Le lien de réinitialisation de mot de passe que vous avez utilisé
            est invalide ou a expiré. Veuillez demander un nouveau lien.
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              >
                {showConfirmPassword ? <span>👁️</span> : <span>👁️</span>}
              </button>
            </div>
