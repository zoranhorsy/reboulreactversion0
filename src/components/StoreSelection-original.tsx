              ...
              {collections.map((store, index) => (
                ...
                >
                  ...
                  >
                    ...
                    {/* Contenu principal */}
                    <div
                      className="absolute inset-0 p-3 xs:p-4 sm:p-6 md:p-10 lg:p-12 
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.div
                          initial={{ opacity: 0, y: -10 }}
                          animate={
                            selectedSlide === index ? { opacity: 1, y: 0 } : {}
                          }
                    ...
                    {store.hasNewProducts && (
                      ...
                      >
                        <div
                          className="bg-red-500/90 text-white px-1.5 py-0.5 xs:px-2 sm:px-3 md:px-4 md:py-1.5 rounded-full 
    text-[7px] xs:text-[8px] sm:text-[10px] md:text-xs uppercase tracking-wide xs:tracking-wider shadow-sm flex items-center gap-1 xs:gap-1.5"
                    ...
                    {store.productCount !== undefined &&
                      store.productCount > 0 && (
                        ...
                        >
                          <div
                            className="bg-black/40 backdrop-blur-sm text-white px-1 py-0.5 xs:px-1.5 sm:px-2 md:px-2.5 md:py-1
    text-[7px] xs:text-[8px] sm:text-[10px] md:text-xs rounded-md"
                          >
                            {store.productCount}{" "}
                            {store.productCount > 1 ? "produits" : "produit"}
                          </div>
                        </motion.div>
                      )}
