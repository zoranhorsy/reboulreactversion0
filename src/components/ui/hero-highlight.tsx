...
export const HeroHighlight = ({
  ...
  // SVG patterns pour différents états et thèmes
  const dotPatterns = {
    light: {
  ...
  return (
    <div
      className={cn(
        "group relative w-full items-center justify-center bg-white dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-zinc-300 to-zinc-400 px-1 pb-1 dark:from-zinc-500 dark:to-zinc-600`,
        className,
      )}
    >
      {children}
