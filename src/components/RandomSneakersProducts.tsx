...
export function RandomSneakersProducts() {
    ...
    useEffect(() => {
        const fetchRandomSneakersProducts = async () => {
            try {
                setIsLoading(true)
                const response = await api.fetchProducts({ store_type: "sneakers", limit: "50" })
                ...
                console.error('Erreur lors de la récupération des produits sneakers aléatoires:', err)
            ...
            <div className="relative overflow-hidden bg-zinc-900">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="relative w-full h-full">
                        <motion.div 
                            className="absolute inset-0 bg-[url('/images/header/reboul/2.png')] 
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <p className="text-lg sm:text-xl text-zinc-300">
                                Découvrez notre collection exclusive de sneakers rares et limitées
                            </p>
                        </motion.div>
