...
export interface AdulteContentProps {
...
export function AdulteContent({
  ...
  const loadProducts = useCallback(async () => {
    ...
    try {
      ...
      // Force store_type à "adult"
      activeFilters.store_type = "adult"
  ...
  const updateFilter = useCallback(
    (newFilters: Partial<FilterState>) => {
      setFilters((prevFilters) => {
        ...
        const newUrl = `/adulte?${params.toString()}`
