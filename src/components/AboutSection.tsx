    ...
    return (
        <section className="about-section bg-gray-100 py-24">
            <div className="container mx-auto px-4">
                <h2 className="animate-on-scroll text-3xl font-bold mb-8 text-center text-black">À propos de Reboul Store</h2>
                <div className="flex flex-col lg:flex-row items-center gap-8">
                    <div className="lg:w-1/2 animate-on-scroll">
                        <Image src="/placeholder.svg" alt="Reboul Store" width={600} height={400} className="about-image rounded-lg shadow-md" />
                    </div>
