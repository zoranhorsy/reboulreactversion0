...
import { createViewportLoadedComponent, createInteractionLoadedComponent, useIdlePreload } from '@/lib/dynamic-loading-strategies'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6 animate-slide-up delay-100">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">
            Cette section est chargée immédiatement car elle fait partie du contenu essentiel.
            Les animations utilisent des classes CSS au lieu de framer-motion.
          </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Cet éditeur se charge uniquement lorsque vous interagissez avec lui.
              Passez la souris sur le bouton ci-dessous pour déclencher le chargement.
            </p>
...
const LazyStatsTab = () => (
  <div className="h-[300px] flex items-center justify-center">
    <p className="text-gray-600 dark:text-gray-300">Statistiques en cours de développement</p>
  </div>
)
...
const Lazy3DModelViewer = () => (
  <div className="h-[300px] flex items-center justify-center">
    <p className="text-gray-600 dark:text-gray-300">Visualisation 3D en cours de développement</p>
  </div>
)
