...
export function OptimizedRandomAdultProducts() {
    ...
    const shuffledProducts = React.useMemo(() => {
        if (!allProducts || allProducts.length === 0) return { carousel: [], featured: [] };
        ...
        <div className="relative w-full overflow-hidden">
                        ...
                        <div className="mt-8 text-center">
                            ...
                            >
                                <Link href="/catalogue?store_type=adult">
                                    Voir tout <ChevronRight className="ml-2 h-4 w-4" />
                                </Link>
                            </Button>
                        </div>
                    </div>
            ...
            <div className="py-16 sm:py-20 container mx-auto px-4 sm:px-6">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
                    <div>
                        <h2 className="text-3xl sm:text-4xl font-bold mb-2 sm:mb-4">Produits en vedette</h2>
