...
export default function MigratedDockMenu() {
  ...
  return (
    ...
    >
      ...
      <div className={cn(dockStyles.menuContainer, isOpen && dockStyles.menuVisible)}>
        <AnimatePresence>
            ...
            >
              {item.id === 'catalogue' ? (
                ...
                <Menu>
                  ...
                  <MenuContent 
                    className="bg-zinc-900/90 dark:bg-zinc-100/90 backdrop-blur-md rounded-lg p-1 min-w-[140px] whitespace-nowrap border border-zinc-800/50 dark:border-zinc-200/50 shadow-lg shadow-zinc-900/20 dark:shadow-zinc-300/20"
                    side="top" 
                    align="center"
                  >
