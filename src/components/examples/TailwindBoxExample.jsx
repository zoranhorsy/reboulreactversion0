...
export function TailwindBoxExample() {
  return (
    <div>
      ...
      <div
        className="p-5 shadow-md border border-gray-200 rounded-md bg-white mb-6"
      >
      ...
      {/* Flex */}
      <div 
        className="flex justify-between items-center p-4 mb-6 bg-blue-50 rounded-md"
      >
      ...
      {/* VStack (Flex column) */}
      <div
        className="flex flex-col gap-4 p-4 mb-6 bg-green-50 rounded-md"
      >
      ...
      {/* HStack (Flex row) */}
      <div
        className="flex flex-row gap-4 p-4 mb-6 bg-purple-50 rounded-md"
      >
        <div className="p-2 bg-purple-200 rounded-md">
          Élément horizontal 1
        </div>
        <div className="p-2 bg-purple-300 rounded-md">
          Élément horizontal 2
        </div>
        <div className="p-2 bg-purple-400 rounded-md">
      ...
      {/* Grid */}
      <div
        className="grid grid-cols-3 gap-6 p-4 mb-6 bg-orange-50 rounded-md"
      >
        ...
        <div className="p-2 bg-orange-600 rounded-md text-white">
          Cellule 5
        </div>
        <div className="p-2 bg-orange-700 rounded-md text-white">
          Cellule 6
        </div>
      </div>
      ...
      <div
        className="p-5 bg-red-50 md:bg-blue-50 lg:bg-green-50 text-red-500 md:text-blue-500 lg:text-green-500 rounded-md mb-6"
      >
        <h3 className="text-lg font-semibold mb-4">
          Box avec styles responsifs
        </h3>
      ...
      <div
        className="p-5 bg-gray-100 rounded-md hover:bg-blue-100 active:bg-blue-200 transition-all duration-200 cursor-pointer"
      >
        <h3 className="text-lg font-semibold mb-4">
          Box avec pseudo-classes
        </h3>
