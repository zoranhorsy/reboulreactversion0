...
export interface SneakersContentProps {
...
export function SneakersContent({
  initialProducts,
  total: initialTotal,
  ...
  const loadProducts = useCallback(async () => {
    ...
    try {
      ...
      // Force store_type à "sneakers"
      activeFilters.store_type = "sneakers"
  ...
  const updateFilter = useCallback(
    (newFilters: Partial<FilterState>) => {
      setFilters((prevFilters) => {
        ...
        const newUrl = `/sneakers?${params.toString()}`
