...
// Supprimé l'import inutile de framer-motion qui causait l'erreur 500
      ...
      try {
        ...
        ctx = gsap.context(() => {
          ...
          const parallaxElements =
            gsap.utils.toArray<HTMLElement>(".gsap-parallax");
          ...
          if (productCards.length) {
            productCards.forEach((cardGroup) => {
              const cards = gsap.utils.toArray<HTMLElement>(
                cardGroup.querySelectorAll(".card-item"),
              );
          ...
          cornerTimeline
            ...
            .from(
              ".the-corner-section .description",
              {
                y: 30,
                opacity: 0,
                duration: 0.6,
        ...
        }, mainRef.current || undefined); // Portée au niveau du ref principal
      } catch (error) {
