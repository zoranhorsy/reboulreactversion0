...
import { fetchUserAddresses, createAddress, updateAddress, deleteAddress, type Address } from '@/lib/api'
                                        ...
                                        <AlertDialogContent>
                                            <AlertDialogHeader>
                                                ...
                                                <AlertDialogDescription>
                                                    Cette action ne peut pas être annulée. L&apos;adresse sera définitivement supprimée.
                                                </AlertDialogDescription>
                                            </AlertDialogHeader>
                                            <AlertDialogFooter>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={e => setCurrentAddress(prev => prev ? { ...prev, street: e.target.value } : null)}
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={e => setCurrentAddress(prev => prev ? { ...prev, city: e.target.value } : null)}
                                />
                            </div>
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    onChange={e => setCurrentAddress(prev => prev ? { ...prev, postal_code: e.target.value } : null)}
                                />
                            </div>
                            <div className="space-y-2">
