...
// Données complètes avec exactement 146 lignes - TOUS EN E25
...
const completeData = [
  ...
  { cod_article: "5 009 48928", reference: "ME243018/103 42", px_achat: 83.00, stock: 3, valeur: 249.00, pla: "E25" },
  { cod_article: "5 009 48929", reference: "ME251001/154 40", px_achat: 71.00, stock: 1, valeur: 71.00, pla: "E25" },
  { cod_article: "5 009 48930", reference: "ME251005/998 46", px_achat: 67.00, stock: 2, valeur: 134.00, pla: "E25" },
  { cod_article: "5 009 48949", reference: "WE241004/998 36", px_achat: 82.00, stock: 1, valeur: 82.00, pla: "E25" },
  { cod_article: "5 009 48950", reference: "WE251002/102 37", px_achat: 69.00, stock: 2, valeur: 138.00, pla: "E25" },
  { cod_article: "5 009 48951", reference: "WE251006/155 37", px_achat: 65.00, stock: 3, valeur: 195.00, pla: "E25" },
  { cod_article: "5 009 48952", reference: "WE251007/262 36", px_achat: 71.00, stock: 1, valeur: 71.00, pla: "E25" },
  { cod_article: "5 009 48953", reference: "WE251008/982 36", px_achat: 65.00, stock: 2, valeur: 130.00, pla: "E25" },
  { cod_article: "5 009 48954", reference: "WE251009/263 36", px_achat: 75.00, stock: 1, valeur: 75.00, pla: "E25" },
...
const outputPath = path.join(__dirname, '../data/mercer-stock-146-lignes-E25-corrige.xlsx');
XLSX.writeFile(workbook, outputPath);

console.log(`Fichier Excel corrigé créé avec succès : ${outputPath}`);
